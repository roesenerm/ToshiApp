...
#coinbase_your_callback_url = 'http://127.0.0.1:5000/consumer_auth'
...
def send_btc(send_to, ticket_price_satoshis, access_token, refresh_token):
	...
	client = OAuthClient(access_token, refresh_token)
	account_id = coinbase_accounts.find_one({'my_address':my_address})['coinbase_user_id']
	account = client.get_account(account_id)
	print (account)

	ticket_price_btc = ticket_price_satoshis / 100000000

	print (float(ticket_price_btc))
